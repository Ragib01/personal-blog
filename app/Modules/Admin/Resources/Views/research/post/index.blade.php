    ...
    <div class="animated fadeIn">
        ...
        <div class="card">
            <div class="card-header">
                <i class="fa fa-edit"></i>Research Post List
            </div>
            <div class="card-block">
                <div class="row col-md-4">
                    <a href="{{ route('admin_research_create') }}">
                    ...
                    @foreach($posts as $post)
                        <tr>
                            ...
                            <td class="text-center">
                                <a class="btn btn-success" href="{{ route('admin_research_show', ['id' => $post->id]) }}">
                                    <i class="fa fa-search-plus "></i>
                                </a>
                                <a class="btn btn-info" href="{{ route('admin_research_edit', ['id' => $post->id]) }}">
                                    <i class="fa fa-edit "></i>
                                </a>
                                <a class="btn btn-danger delete" href="javascript:void(0)">
                                    <i class="fa fa-trash-o "></i>
                                </a>
                                <input class="delete_url" type="hidden" value="{{ route('admin_research_delete', ['id' => $post->id]) }}">
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
