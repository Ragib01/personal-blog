                    ...
                    <div class="col-12">
                        <div class="card email-app">
                            ...
                            @foreach($mails as $mail)
                                    <li class="unread">
                                        <a href="{{ route('admin_mail_show', ['id' => $mail->id]) }}">
                                            <div class="header">
                                                    <span class="action"><i class="fa fa-user"></i>
                                                    </span>
                                                <span class="from">{{ $mail->name }}</span>
                                                <span class="date">
                                                        <span class="fa fa-paper-clip"></span>{{ $mail->updated_at->format('d/m/Y') }}</span>
                                            </div>
                                            <div class="title">
                                            ...
                                            <div class="description">
                                                <?php echo substr( $mail->message,0,300) ?>
                                            </div>
                                        </a>
                                    </li>
                                @endforeach
            ...
            <div class="tab-pane active" id="timeline" role="tabpanel">
                ...
                <div class="callout callout-info m-0 py-1">
                    <div class="avatar pull-xs-right">
                        <img src="{{ url('admin/img/avatars/7.jpg') }}" class="img-avatar" alt="admin@bootstrapmaster.com">
                    </div>
                    <div>Skype with
                        <strong>Megan</strong>
                    </div>
