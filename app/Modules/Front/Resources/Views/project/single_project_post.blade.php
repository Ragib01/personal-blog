        ...
        <div class="container">
            <div class="row">
                    ...
                    <div class="blog-classic">
                        <div class="blog-post">
                            ...
                            <ul class="post-meta">
                                ...
                                <li><i class="fa fa-folder-open"></i>  <a href="#">{{$post->projectCategory->title}}</a></li>
                                </li>
                            </ul>
                ...
                <div class="col-md-4">
                    ...
                    <div class="widget">
                        <div class="heading-title-alt text-left heading-border-bottom">
                            <h6 class="text-uppercase">Related Article</h6>
                        </div>
                        <ul class="widget-latest-post">
                            @foreach($related as $post)
                                <li>
                                    <div class="w-desk">
                                        <a href="{{url('project/'.$post->id.'/show')}}">{{ $post->title }}</a>
                    ...
                    <div class="widget">
                        ...
                        <ul class="widget-category">
                            @foreach($categories as $category)
                                <li><a href="{{url('project/'.$category->id.'/category')}}">{{ $category->title }}</a>
                                </li>
                            @endforeach
                        </ul>
                    </div>
