...
@section('breadcrumb')
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Breaking Posts</li>
    </ol>
@endsection
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    {!! Form::open(['url' => route('admin_breaking_update', ['id' => $post->id]), 'method' => 'post', 'files' => true, 'class' => 'form-horizontal']) !!}
                    <div class="card-block">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="text" id="url" name="url" value="{{ old('url') ? old('url') : $post->url}}" class="form-control" placeholder="Example https://www.facebook.com/">
                                @if($errors->first('url'))
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <select id="status" name="status" class="form-control" size="1">
                                ...
                                <option value="2" {{ $post->status == 2 ? 'selected="selected"' : '' }}>Deactive</option>
