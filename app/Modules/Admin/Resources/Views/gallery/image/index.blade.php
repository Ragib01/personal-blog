    ...
    <div class="animated fadeIn">
        ...
        <div class="card">
            <div class="card-header">
                <i class="fa fa-edit"></i> Gallery Images List
            </div>
            <div class="card-block">
                <div class="row col-md-4">
                    <a href="{{ route('admin_gallery_create') }}">
                ...
                <table class="table table-striped table-bordered datatable">
                    ...
                    @foreach($images as $image)
                        <tr>
                            ...
                            <td>
                                <img src="{{ url('uploads/images/gallery-image/' . $image->image) }}" width="130" height="100" alt="images">
                            </td>
                            <td>
                                {{ $image->category_id }}
                            </td>
                            ...
                            <td class="text-center">
                                <a class="btn btn-info" href="{{ route('admin_gallery_edit', ['id' => $image->id]) }}">
                                    <i class="fa fa-edit "></i>
                                </a>
                                <a class="btn btn-danger delete" href="javascript:void(0)">
                                    <i class="fa fa-trash-o "></i>
                                </a>
                                <input class="delete_url" type="hidden" value="{{ route('admin_gallery_delete', ['id' => $image->id]) }}">
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
