...
var Popover = Class.extend(ListenerMixin, {
	...
	// Triggered when the app clicks *anywhere* in the document, for the autoHide feature
...
var CoordCache = FC.CoordCache = Class.extend({
	...
	// Compute and return what the elements' bounding rectangle is, from the app's perspective.
...
DragListener.mixin({
	...
	// Called when scrolling has stopped, whether through auto scroll, or the app scrolling
...
var HitDragListener = DragListener.extend({
	...
	handleScrollEnd: function() {
		...
		// hits' absolute positions will be in new places after a app's scroll.
...
/*
Listens to document and window-level app-interaction events, like touch events and mouse events,
...
var MouseFollower = Class.extend(ListenerMixin, {
	...
	// Gets called when the app moves the mouse
	handleMove: function(ev) {
...
var Grid = FC.Grid = Class.extend(ListenerMixin, {
	...
	hasDayInteractions: true, // can app click/select ranges of time?
	...
	dayMousedown: function(ev) {
		...
		// prevent a app's clickaway for unselecting a range or an event from
	...
	// Creates a listener that tracks the app's drag across day elements, for day clicking.
	buildDayClickListener: function() {
		...
		var dragListener = new HitDragListener(this, {
			...
			hitOver: function(hit, isOrig, origHit) {
				// if app dragged to another cell at any point, it can no longer be a dayClick
				if (!isOrig) {
					dayClickHit = null;
				}
			},
	...
	// Creates a listener that tracks the app's drag across day elements, for day selecting.
	...
	// Will return false if the selection is invalid and this should be indicated to the app.
...
Grid.mixin({
	...
	mousedOverSeg: null, // the segment object the app's mouse is over. null if over nothing
	...
	unrenderEvents: function() {
		this.handleSegMouseout(); // trigger an eventMouseout if app's mouse is over an event
		this.clearDragListeners();
	...
	// Executes a handler for any a app-interaction on a segment.
	...
	// Builds a listener that will track app-dragging on an event segment.
	...
	// Creates a listener that tracks the app as they resize an event segment.
	// Generic enough to work with any type of Grid.
...
DayGrid.mixin({
	...
	showSegPopover: function(row, col, moreLink, segs) {
		...
		options = {
			...
			autoHide: true, // when the app clicks elsewhere, hide the popover
...
var View = FC.View = Class.extend(EmitterMixin, ListenerMixin, {
	...
	isRTL: false,
	isSelected: false, // boolean whether a range of time is app-selected or not
	selectedEvent: null,
	...
	// Computes the new date when the app hits the prev button, given the current date
	...
	// Computes the new date when the app hits the next button, given the current date
	...
	// Computes if the given event is allowed to be dragged by the app
	...
	// Computes if the given event is allowed to be resized by the app at all
...
function Calendar_constructor(element, overrides) {
	...
	// TODO: maintain any other app-manipulated state.
	function reinitView() {
		ignoreWindowResize++;
		freezeContentHeight();
...
var AgendaView = FC.AgendaView = View.extend({
	...
	// Computes the initial pre-configured scroll state prior to allowing the app to change it
	computeInitialScroll: function() {
...
/*
Responsible for event rendering and app-interaction.
