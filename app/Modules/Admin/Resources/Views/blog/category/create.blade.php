        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    {!! Form::open(['url' => route('admin_blog_category_store'), 'method' => 'post', 'files' => true, 'class' => 'form-horizontal']) !!}
                        ...
                        <div class="card-footer">
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <a class="btn btn-sm btn-danger" href="{{ route('admin_blog_category_index') }}">Go Back</a>
                                </div>
                            </div>
                        </div>
                    {!! Form::close() !!}
