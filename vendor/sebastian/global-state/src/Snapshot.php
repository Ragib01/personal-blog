...
class Snapshot
{
    ...
    /**
     * Creates a snapshot app-defined constants.
     */
    private function snapshotConstants()
    {
        $constants = get_defined_constants(true);

        if (isset($constants['app'])) {
            $this->constants = $constants['app'];
        }
    }

    /**
     * Creates a snapshot app-defined functions.
     */
    private function snapshotFunctions()
    {
        $functions = get_defined_functions();

        $this->functions = $functions['app'];
    }

    /**
     * Creates a snapshot app-defined classes.
     */
    ...
    /**
     * Creates a snapshot app-defined interfaces.
     */
    ...
    /**
     * Creates a snapshot of all static attributes in app-defined classes.
     */
