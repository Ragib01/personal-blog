        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    {!! Form::open(['url' => route('admin_project_category_update', ['id' => $category->id]), 'method' => 'post', 'files' => true, 'class' => 'form-horizontal']) !!}
                    <div class="card-block">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <img src="{{ url('uploads/images/project-category/' . $category->image) }}" style="width: 300px; height: 300px" alt="">
                            </div>
                        </div>
                    </div>
                    <div class="card-footer">
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                ...
                                <a class="btn btn-sm btn-danger" href="{{ route('admin_project_category_index') }}">Go Back</a>
                            </div>
                        </div>
                    </div>
                    {!! Form::close() !!}
