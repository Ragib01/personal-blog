        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    {!! Form::open(['url' => route('admin_slider_update', ['id' => $slider->id]), 'method' => 'post', 'files' => true, 'class' => 'form-horizontal']) !!}
                    <div class="card-block">
                        <div class="form-group row">
                            <label class="col-md-2 form-control-label text-right" for="title">Title</label>
                            <div class="col-md-9">
                                <input type="text" id="title" name="title" value="{{ old('title') ? old('title') : $slider->title}}" class="form-control" placeholder="slider Title">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <img src="{{ url('uploads/images/slider/' . $slider->image) }}" style="width: 300px; height: 300px" alt="">
                            </div>
                        </div>
                    </div>
