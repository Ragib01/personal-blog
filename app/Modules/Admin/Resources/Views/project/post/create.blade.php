        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    {!! Form::open(['url' => route('admin_project_store'), 'method' => 'post', 'files' => true, 'class' => 'form-horizontal']) !!}
                    <div class="card-block">
                        ...
                        <div class="form-group row">
                            <label class="col-md-2 form-control-label  text-right" for="url">Upload File</label>
                            <div class="col-md-9">
                    ...
                    <div class="card-footer">
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                ...
                                <a class="btn btn-sm btn-danger" href="{{ route('admin_project_index') }}">Go Back</a>
                            </div>
                        </div>
                    </div>
                    {!! Form::close() !!}
