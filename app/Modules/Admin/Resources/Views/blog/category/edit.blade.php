        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    {!! Form::open(['url' => route('admin_blog_category_update', ['id' => $category->id]), 'method' => 'post', 'files' => true, 'class' => 'form-horizontal']) !!}
                    <div class="card-block">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <img src="{{ url('uploads/images/blog-category/' . $category->image) }}" style="width: 300px; height: 300px" alt="">
                            </div>
                        </div>
                    </div>
